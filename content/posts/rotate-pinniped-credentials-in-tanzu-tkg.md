...
We've successfully [implemented user authentication](/posts/user-auth-in-tanzu-tkg/) in our TKG clusters. Now, we'd like to update the client ID/secret for our TKG Management Cluster.
