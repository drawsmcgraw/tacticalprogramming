...
A typical follow up to [getting your hands around your internal cloud](/posts/salted-vmware-part-01/) is going to be management of your network space. Let's go through how Salt's event bus can help us solve this problem. This post assumes a simple setup of a `/24` network.
